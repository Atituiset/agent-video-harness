...
这些修法提炼自真实交付的作品——《从一次 LLM 调用到完整 Harness》（17 帧双语科普，zh 3m33s / en 3m10s）——并沉淀为 33 条实战规则，覆盖箭头几何、CJK 字体子集化、WCAG ghost text、seek 安全等。
...
| 技能 | 用途 |
|---|---|
| [bilingual-video](skills/video/bilingual-video/) | **任何双语视频**的通用生产层——双工程、配音与词边界字幕、迭代闭环、发布惯例、33 条通用踩坑清单。 |
